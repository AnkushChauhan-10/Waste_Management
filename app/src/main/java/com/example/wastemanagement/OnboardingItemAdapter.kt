...
class OnboardingItemAdapter(private val onboardingItem : List<OnboardingItem>):RecyclerView.Adapter<OnboardingItemAdapter.OnboardingItemViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnboardingItemViewHolder {
        return OnboardingItemViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.onbording_item_container,parent,false)
        )
    }
    ...
    inner class OnboardingItemViewHolder(view: View):RecyclerView.ViewHolder(view){
        ...
        private val imageOnboarding = view.findViewById<ImageView>(R.id.onbordingImage)
